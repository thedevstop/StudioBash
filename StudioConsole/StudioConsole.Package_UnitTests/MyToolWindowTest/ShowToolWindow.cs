...
using TheDevStop.StudioConsole;

namespace StudioConsole.Package_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new StudioConsole_PackagePackage() as IVsPackage;
            ...
            MethodInfo method = typeof(StudioConsole_PackagePackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
