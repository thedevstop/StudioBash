...
namespace StudioBash.Package_UnitTests.MyToolWindowTest
{
    ...
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new StudioBash_PackagePackage() as IVsPackage;
            ...
            MethodInfo method = typeof(StudioBash_PackagePackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
